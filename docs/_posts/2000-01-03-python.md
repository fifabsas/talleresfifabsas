...
## Material extra
* [**Presentación ajustes**](https://drive.google.com/file/d/1aZZcTZdJJvx7NYRCu7UUue-Pgz7SLUbB/view?usp=sharing)
* [**Notebooks útiles**](https://github.com/fifabsas/talleresfifabsas/tree/master/python/Extras/): En nuestro GitHub pueden encontrar varias notebooks con contenido extra. Entre ellas hay un ejemplo de uso de la biblioteca pandas, una simulación bien completa de un ejercicio de Física 1 y una con adquisición programada de datos.
